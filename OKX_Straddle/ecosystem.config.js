...
//   pm2 start ecosystem.config.js --only okx-reporting-prod
//   pm2 logs okx-straddle-prod
//   pm2 logs okx-reporting-prod --lines 200
//   pm2 restart okx-reporting-prod                      # manual report trigger
...
//
//   15 10 * * * HOME=/root /usr/local/bin/pm2 restart okx-reporting-prod \
//     >> /root/cex_option_trading/OKX_Straddle/data/logs/cron.log 2>&1
//
...
//   pm2 restart okx-reporting-prod
//   pm2 logs okx-reporting-prod
...
const ROOT_BY_ENV = {
  prod: "/root/cex_option_trading/OKX_Straddle",
  test: "/Users/eugene/Documents/projects/cex_option_trading/OKX_Straddle",
};
...
const makeStrategyApp = (env) => ({
  ...
  out_file:      `./data/logs/okx-straddle-${env}.out.log`,
  error_file:    `./data/logs/okx-straddle-${env}.err.log`,
});
